...
#' Let \eqn{(u_i,v_i) := (F_n(x_i),G_n(y_i))} be the pseudo-observations for \eqn{i \in \{1,\ldots,n\}} and \eqn{(u_1',v_1'),\ldots, (u_m',v_m')} the distinct pairs of pseudo-observations with \eqn{m \leq n}. Moreover set
#' \eqn{S_1:=\{0, u_1, \ldots, u_{m_1}\}} and \eqn{S_2:=\{0, v_1,\ldots, v_{m_2}\}} and define the quantities \eqn{t_i,r_i} and \eqn{s_i} for \eqn{i=1,\ldots, m} by
...
#' Define the empirical subcopula \eqn{A'_n: S_1 x S_2 to \{0,1/n, \ldots, (n-1)/n,1\}} by
